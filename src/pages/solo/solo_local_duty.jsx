...
function Solo_local_duty() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      data.trip_type = "Solo Local Duty ";
      data.bulk_id = bulkId;
    ...
    <div className="min-h-full bg-blue-50 flex items-start justify-center p-4">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div>
            <label className="font-semibold text-gray-700 flex items-center gap-2">
              <FaMoneyBill className="text-green-500" /> Extra KM Charge
            </label>
            <input
              type="number"
          ...
          <div>
            <label className="font-semibold text-gray-700 flex items-center gap-2">
              <FaMoneyBill className="text-indigo-500" /> Extra Hr Charge
            </label>
            <input
              type="number"
...
export default Solo_local_duty;
